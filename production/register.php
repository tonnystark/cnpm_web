...
if(isset($_POST['btnRegister']))
{
  ...
  if($pass==$repass)
  {
    $iduser=$user->DkyTaiKhoan($username,$pass,$name,$email);
  }
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post">
              ...
              <div>
                <input type="password" class="form-control" placeholder="Re-Password" required=""  name="repsw"/>
              </div>
              <div>
                <button type="submit" class="btn btn-default submit"  name="btnRegister">Register</button>
                <a class="reset_pass" href="login.php">Have an account?</a>
              </div>
